...
import Banner from "../../assets/women/footer-pattern.jpeg";
import {
    FaFacebook,
    FaInstagram,
    FaLinkedin,
...
>
    ...
    Shopify</h1>
<p>Lorem ipsum dolor sit amet consecutetur
    adipisicing elit.Cum in
    beatea ea recusandae blanditiis veritatis.
     </p>
</div>
{/*Footer Links */}
        ...
        <ul className="flex flex-col  gap-3">
            {
                FooterLinks.map((link)=>(
                    ...
                    hover:text-primary hover:translate-x-1 durtion-300
                    text-gray-200"
                     key={link.title}>
